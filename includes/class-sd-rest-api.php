...
class Sd_Rest_Api {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Sd_Rest_Api_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	...
	public function __construct() {
		if ( defined( 'SD_REST_API_VERSION' ) ) {
			$this->version = SD_REST_API_VERSION;
		} else {
			$this->version = '1.0.0';
		}
		$this->plugin_name = 'sd-rest-api';
	...
	private function define_admin_hooks() {
		...
		$plugin_admin = new Sd_Rest_Api_Admin( $this->get_plugin_name(), $this->get_version() );
	...
	private function define_public_hooks() {
		...
		$plugin_public = new Sd_Rest_Api_Public( $this->get_plugin_name(), $this->get_version() );
	 ...
	 *
	 * @since     1.0.0
	 * @return    Sd_Rest_Api_Loader    Orchestrates the hooks of the plugin.
	 */
